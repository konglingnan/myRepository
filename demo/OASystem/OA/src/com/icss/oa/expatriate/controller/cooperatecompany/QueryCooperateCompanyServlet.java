...
@WebServlet("/QueryCooperateCompanyServlet")
public class QueryCooperateCompanyServlet extends HttpServlet {
...
//		创建业务对象
		...
		try {
			...
			ArrayList<CooperateCompany> list=service.queryAllCooperateCompany(pager	);
