...
window.onload = function() {
	...
	oDiv.onmousedown = function(ev) {
		...
		function mouseMove(ev) {
			...
			// 计算比例
			var scale = oDiv.offsetTop/(out.offsetHeight-oDiv.offsetHeight);

			// 内容区可滚动范围
			var range = contentInner.offsetHeight-content.offsetHeight;
			// 滚动内容
			contentInner.style.top = -scale*range+"px";
		}
