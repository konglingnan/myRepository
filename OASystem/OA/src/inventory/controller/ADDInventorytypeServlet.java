...
/**
 * Servlet implementation class ADDInventorytypeServlet
 */
@WebServlet("/ADDInventorytypeServlet")
public class ADDInventorytypeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ADDInventorytypeServlet() {
        super();
...
//		获得请求参数
		...
		String inventorytypeName = request.getParameter("inventorytypeName");
				System.out.println(inventorytypeName);
//		封装数据
...
//		创建业务对象
		...
		try {
			service.addInventorytype(inventorytype);
